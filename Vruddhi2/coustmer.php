    ...
    <div class="panel-heading" role="tab" id="collapseListGroupHeading1">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" href="#collapseListGroup1" aria-expanded="false" aria-controls="collapseListGroup1">
          Shop & Support<span class="glyphicon glyphicon-chevron-down"></span>
        </a>
      </h4>
    </div>
    <div id="collapseListGroup1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading1">
      <ul class="list-group">
        ...
        <div class="col-md-9 ab_right">
            ...
            <hr>
            <div class="row coustmer">
            <div class="col-md-4 coust-br">
                <img src="images/contact%20us.png">
                <h4>CONTACT US</h4>
                <p>Got a question or a comment? Write to us.</p>
                </div>
                 <div class="col-md-4 coust-br">
                     <img src=images/cart.png>
                 <h4>HOW TO ORDER</h4>
                <p>Ordering from www.Vruddhi.com, a step-by-step guide.</p>
                </div>
                 <div class="col-md-4 coust-br">
                     <img src="images/bill.png">
                 <h4>BILLINGS & PAYMENTS</h4>
                <p>Got a question or a comment? Write to us.</p>
                </div>
            </div>
            
                    <div class="row coustmer">
            <div class="col-md-4 coust-br coust-br">
                <img src="images/delivery%20(1).png">
                <h4>SHIPPING & DELIVERY</h4>
                <p>Domestic & International shipping. Delivery methods, times and costs.</p>
                </div>
                 <div class="col-md-4 coust-br">
                     <img src="images/track.png">
                 <h4>TRACK YOUR ORDER</h4>
                <p>Your order status with us and tracking your shipment.</p>
                </div>
                        
                 <div class="col-md-4 coust-br">
                     <img src="images/return%20and%20exchange.png">
                 <h4>RETURNS & EXCHANGES</h4>
                <p>Returning goods, exchanging them, or claiming a refund.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 coust-br coust-br">
                ...
                <h4>FAQ'S</h4>
                <p>Questions frequently asked by our customers.</p>
                </div>
                 <div class="col-md-4 coust-br">
                     <img src="images/scale.png">
                 <h4>PRODUCT SIZING</h4>
                <p>An easy guide to Vruddhi sizes.</p>
                </div>
                 <div class="col-md-4 coust-br">
                     <img src="images/hanger.png">
                 <h4>FABRIC CARE</h4>
                <p>Caring for your handmade Vruddhi product.</p>
                </div>
            </div>
