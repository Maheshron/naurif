...
<section class="about-us">
    ...
    <div class="col-md-3 ab_left">
        <ul class="visible1">
        <li><a href="#">50 Years Of Vruddhi</a></li>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseListGroup1" class="panel-collapse collapsed" role="tabpanel" aria-labelledby="collapseListGroupHeading1">
      <ul class="list-group">
       <li><a href="#">50 Years Of Vruddhi</a></li>
            <li><a href="#">Philosophy</a></li>
            <li><a href="#">Products</a></li>
        ...
        <div class="col-md-9 ab_right">
            ...
            <hr>
            <h3>Vruddhi's Categories Of Food Products</h3>
           <img src="images/organic-logo.png" align="left" style="position:relative; bottom:5px; padding:0px 5px;"><p>Products displaying our Green logo are 'Fully Certified' Organic. All processes, from growing to preparing to packing have been done according to National and International standards, verified by accredited agencies.</p>
            
            <img src="images/organic-logo.png" align="left" style="position:relative; bottom:5px; padding:0px 5px;"><p>Products displaying our Blue logo are 'In Conversion'. This means that the farmer is using purely organic techniques, and has registered and is complying with set standards. Farmland must be managed organically for about 3 years before it can be fully certified.

</p>
            
            <img src="images/organic-logo.png" align="left" style="position:relative; bottom:5px; padding:0px 5px;"><p>Products displaying our Yellow logo are 'Natural'. This category contains products produced by small farmers who use purely organic techniques, but who have decided to not yet register for certification. It also includes some processed foods, which do not contain any synthetic preservatives, colours, flavours or additives.</p>
            
            <br>
            <h3>National And International Standards</h3>
            <p>India's organic certification standards are set by the National Programme for Organic Production (NPOP), which are based on standards set by the International Federation of Organic Agriculture (IFOAM).</p>
          
            <p>In India, there are a handful of certifying agencies accredited by NPOP. Farmers and producers must register with one of these agencies, who will in turn verify whether NPOP standards have been met.</p>
            
            <p>For certified Organic products, look for a certified agency's logo, for example SGS, and NPOP's India Organic logo.</p>
            
         <img src="images/logo-npop.jpg">
            <img src="images/logo-sgs.jpg" >
